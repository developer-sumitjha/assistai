    ...
    <div class="px-4 pb-32 flex-1 overflow-y-auto">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <a href="{{ route('user.tts') }}"
                ...
                <p class="text-[12px] text-slate-400 mt-1">AI Voice Generation</p>
            </a>
            ...
            <div
                ...
                <h3 class="text-[17px] font-bold text-slate-900">Text to Video</h3>
            ...
            <div
                ...
                <h3 class="text-[17px] font-bold text-slate-900">Image to Video</h3>
                <p class="text-[12px] text-slate-400 mt-1">Coming soon</p>
            </div>
        </div>
    </div>
