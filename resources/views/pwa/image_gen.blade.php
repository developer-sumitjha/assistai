                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea x-model="prompt"
                            ...
                            placeholder="A majestic lion wearing a golden crown, digital art, high detail..."></textarea>
                    </div>
                    ...
                    <!-- Generate Button -->
                    <button @click="generateImage()" :disabled="loading || !prompt"
                    ...
                    <button @click="surpriseMe()"
                        class="w-full text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-blue-500 transition-colors">
